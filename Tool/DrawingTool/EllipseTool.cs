...
namespace VectorGraphicRedactor
{
    public class EllipseTool : DrawingTool
    {
        ...
        {
            return new Ellipse(x1, y1, x2, y2, contourColorConfig.ContourColor, fillColorConfig.Color, thicknessConfig.Thickness, 
                                    dashStyleConfig.DashStyle, hatchStyleConfig.HatchStyle.GetBrush(fillColorConfig.Color));
        }
    }
}